		...
		if ( true !== $cntctfrm_result ) { 
			...
			if ( 1 == $cntctfrm_options['cntctfrm_display_name_field'] ) { 
				...
				$content .= '<div style="text-align: left;">
						<input class="text" type="text" size="40" value="nombre" name="cntctfrm_contact_name" id="cntctfrm_contact_name" style="text-align: left; margin: 0;" />
					</div>';
			}
			...
			$content .= '<div style="text-align: left;">
					<input class="text" type="text" size="40" value="E-mail" name="cntctfrm_contact_email" id="cntctfrm_contact_email" style="text-align: left; margin: 0;" />
				</div>
			';
			...
			$content .= '<div style="text-align: left;">
					<textarea rows="5" cols="30" name="cntctfrm_contact_message" id="cntctfrm_contact_message">Mensaje</textarea>
				</div>';
			...
			$content .= '<input type="hidden" value="send" name="cntctfrm_contact_action"><input type="hidden" value="Version: 3.30" />
					...
					<input type="submit" value="'. $cntctfrm_options['cntctfrm_submit_label'][ $lang ] . '" class="botonenviar" /> 
				</div>
				</form>';
		}
		return $content ;
